  ...
  <div id="app" class="container my-3">
    ...
    <div class="card mt-3">
      ...
      <div class="card-body">
        ...
        <button class="btn btn-sm btn-primary" @click="postData">Post</button>
...
export default {
  ...
  methods: {
    ...
    async getAllData() {
      try {
        const res = await fetch(`${baseURL}/samples`);
    ...
    async getDataById() {
      ...
      if (id) {
        try {
          const res = await fetch(`${baseURL}/samples/${id}`);
    ...
    async getDataByTitle() {
      ...
      if (title) {
        try {
          // const res = await fetch(`${baseURL}/samples?title=${title}`);

          let url = new URL(`${baseURL}/samples`);
    ...
    async deleteAllData() {
      try {
        const res = await fetch(`${baseURL}/samples`, { method: "delete" });
    ...
    async deleteDataById() {
      ...
      if (id){
        try {
          const res = await fetch(`${baseURL}/samples/${id}`, { method: "delete" });
